/*Consider a telephone book database of N clients. Make use of hash table implementation to quickly look up client’s telephone number .

Make use of two collision handling technique and compare them using number of comparisons required to find a set of telephone number.
